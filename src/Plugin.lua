...
local master = {["BaseClass"] = "https://raw.githubusercontent.com/TheFlamingBlaster/FDK/master/src/BaseClass.lua", ["FDK"] = "https://raw.githubusercontent.com/TheFlamingBlaster/FDK/master/src/FDK.lua"}
-- Where the sources for each branch are located.
local dev = {}
local legacy = {}

local masterButton = toolbar:CreateButton("Import Master", "Imports the master FDK enviroment into ReplicatedStorage. This one should be stable and fully functional.", "")
local newPackageButton = toolbar:CreateButton("New Package")
...
masterButton.Click:Connect(function()
	...
	print("\nSuccessfully installed FDK into ReplicatedStorage.\nCheck the GitHub page at TheFlamingBlaster/FDK for usage instructions in setting up your own packages.")
end)